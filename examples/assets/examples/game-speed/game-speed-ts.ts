...
export default class GameSpeed extends cc.Component {
    ...
    @property(cc.Node) actionNode: cc.Node | undefined = undefined
    @property(cc.Node) tweenNode: cc.Node | undefined = undefined
    @property(cc.Node) updateNode: cc.Node | undefined = undefined
    ...
    setSpeed(event: cc.Event, str: string) {
        const s = +str
        cc.log('set speed: ' + s)
        cc.kSpeed(s)
    }
